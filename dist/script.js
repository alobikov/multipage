...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var mainSlider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: ".page",
    btns: ".next"
  });
  mainSlider.render();
  ...
  feedSlider.setup();
  var player = new _modules_player__WEBPACK_IMPORTED_MODULE_2__["default"](".overlay", ".showup .play");
  player.setup();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"](".officernew", ".officer__card-item").setup();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"](".officerold", ".officer__card-item").setup();
});
...
/*#__PURE__*/
function () {
  function Difference(containerSl, cardsSl) {
    _classCallCheck(this, Difference);

    var LIIT = 3; // how many cards to fit in view
...
/*#__PURE__*/
function () {
  function Player(selector, triggers) {
  ...
  _createClass(Player, [{
    key: "startPlayer",
    value: function startPlayer(url) {
      if (document.querySelector("iframe#frame")) {
        console.log("exists"); //   this.player.playVideo();
      } else {
    ...
    key: "bindOpen",
    value: function bindOpen(btns) {
      var _this = this;

      btns.forEach(function (btn) {
        btn.addEventListener("click", function () {
          _this.overlay.style.display = "flex"; // url video is located in data-url attribute of the button

          var url = btn.getAttribute("data-url");

          _this.startPlayer(url);
        });
      });
    }
  }, {
    key: "bindClose",
    value: function bindClose(btn) {
      var _this2 = this;
...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    _this.slides = _this.container.children;
    console.log("Main_slider: ", _this.slides, _this.container);
    return _this;
  }

  _createClass(MainSlider, [{
    key: "delayShow",
    value: function delayShow(selector, timeout) {
    ...
    value: function showSlide(n) {
      console.log(this.currentIndex); // first take care about boundary cases
    ...
    value: function render() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener("click", function (e) {
          ...
          if (_this2.currentIndex === 3) {
            _this2.delayShow(".hanson", 3000);
          }

          _this2.showSlide(_this2.currentIndex);
        });
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, active, animate, autoplay) {
    var _this;

    _classCallCheck(this, MiniSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, active, animate, autoplay));
  ...
  _createClass(MiniSlider, [{
    key: "decorateSlide",
    value: function decorateSlide() {
      var _this2 = this;

      console.log("decoreteSlide:", this.container); // first remove active class from all slides
    ...
    key: "setIntervalPlay",
    value: function setIntervalPlay() {
      var _this3 = this;
    ...
    value: function setup() {
      ...
      this.container.style.cssText = "\n                                    display : flex;\n                                    flex-wrap : wrap;\n                                    overflow : hidden;\n                                    align-items : flex-start;"; // now let's arrange slides rotation onclick
      ...
      this.prev.addEventListener("click", function (e) {
        ...
        _this4.slides = _this4.container.querySelectorAll(_this4.slideSelector);

        _this4.decorateSlide();
      });
      this.decorateSlide();
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      slideSelector = _ref$slideSelector === void 0 ? ".slide-item" : _ref$slideSelector,
